...
function preload() {
 ...
 img5 = loadImage('assets/Underwater3.jpg');
  ...
  img9 = loadImage('assets/Pyramid7.jfif');
  img10 = loadImage('assets/Rome8.jfif');
  img11 = loadImage('assets/Eiffel9.jfif');
  img12 = loadImage('assets/GreatW10.jfif');
...
var drawScene13 = function(){
  loadImage('assets/Pyramid7.jfif', img => {
    img.resize(400,400);
    image(img, 0,-45);
  });
   loadImage('assets/PaintSplat.png', img => {
...
loadImage('assets/Rome8.jfif', img => {
    img.resize(400,400);
    image(img, 0,-80);
  });
   loadImage('assets/PaintSplat.png', img => {
...
loadImage('assets/Eiffel9.jfif', img => {
    img.resize(400,320);
    image(img, 0,0);
  });
...
var drawScene16 = function(){
  loadImage('assets/GreatW10.jfif', img => {
    img.resize(400,350);
    image(img, 0,0);
  });
